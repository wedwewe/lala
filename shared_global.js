...
{
	return {
		url: 'https://my.steamchina.eccdnx.com/' + this.m_strURL,
		dataType: 'jsonp',
...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( '错误',
					'您的帐户不符合使用该功能的要求。<a class="whiteLink" href="https://help.steampowered.com/zh-cn/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">访问蒸汽平台客服</a>了解更多信息。'
				);
				break;
			case 15:
